...
- [i] **Task 01: 자막 파싱 & 오디오 Fallback 수집기 (`pipeline/loader.py`)** `docs/tasks/01-loader-pipeline.md`
  - `youtube-transcript-api` 자막 추출기
  - 자막 부재 시 `yt-dlp` 오디오 extraction + Whisper/Gemini Fallback
