...
- [x] **Check 3.5**: Extract embedding and transcript-index repository contracts,
...
- [x] **Check 3.9**: Remove the obsolete `storage` compatibility package and
  update direct imports to domain, application contracts, and infrastructure modules.
