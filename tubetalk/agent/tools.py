...
from tubetalk.agent.contracts import ToolCall, ToolResult
from tubetalk.domain.video_status import VideoStatus
from tubetalk.services.video_service import ChatSession, VideoService, VideoServiceError
...
_TOOL_DESCRIPTIONS = {
    ...
    "list_videos": "List videos currently cached by TubeTalk.",
